#!/bin/sh
# Installation script for OSSEC - Modified for Ubuntu Linux
# Intended for OSSUI Web UI Installation
# Modification Author: Ryan Yap
# Original Author: Daniel B. Cid <daniel.cid@gmail.com>
...
# Changelog 20 April 2018 - Added support for dependency downloads
