...
if grep ^ossec: /etc/group > /dev/null 2>&1; then
    echo "Web server user name = apache"
    HTTPDUSER="apache"
...
chmod 770 /var/www/html/ossui/tmp/
chgrp www-data /var/www/html/ossui/tmp/
usermod -a -G ossec www-data
echo "Done"
echo "Restarting Apache..."
service apache2 restart
echo "Done"
echo "Navigate to localhost/ossui in your browser to view alerts."
echo "Restart may be required to view alerts."
